...
const VISION_PROMPT = `You are an expert at reading equipment labels and nameplates. Analyze this image of an IT equipment label and extract all visible information.
...
/**
 * Extract structured label data directly from an image using GPT-4o-mini vision.
 * Single-step: no Tesseract, no intermediate OCR text.
 */
