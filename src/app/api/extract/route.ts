...
import { extractLabelFromImage } from "@/lib/ocr";
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Single-step: send image directly to GPT-4o-mini vision
    const extractedData = await extractLabelFromImage(image, mimeType);
